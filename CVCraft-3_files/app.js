...
function openRichTextEditor(description) {
    description.onclick = null;  // Make description non-clickable
    ...
    const buttons = [
        ...
        { command: 'insertSpecialChar', icon: 'emoji_symbols', description: '🔣: Insert Special Character' }
    ];
...
`;
    ...
    contentArea.innerHTML = description.innerHTML;
    ...
    saveButton.onclick = function () {
        ...
        description.onclick = function() { openRichTextEditor(this); };  // Make description clickable again
    };
